...
describe("DevOps Module - validate.sh stage 6 functional suite", function()
  it("Purge guards (engine, rust, beans, endpoints, import-optimizer, k8s-validator, migrations, conflicts, log-indexer must NOT require)", function()
    assert.has_error(function() require('tetravim.util.engine') end)
    assert.has_error(function() require('tetravim.util.rust') end)
    assert.has_error(function() require('tetravim.util.beans') end)
    assert.has_error(function() require('tetravim.util.endpoints') end)
    assert.has_error(function() require('tetravim.util.import-optimizer') end)
    assert.has_error(function() require('tetravim.util.k8s-validator') end)
    assert.has_error(function() require('tetravim.util.migrations') end)
    assert.has_error(function() require('tetravim.util.conflicts') end)
    assert.has_error(function() require('tetravim.util.log-indexer') end)
  end)
  ...
  it("API surface (spring and spring-picker)", function()
