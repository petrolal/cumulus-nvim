...
describe("DevOps Module - validate.sh stage 6 functional suite", function()
  it(
    ...
    function()
      ...
      assert.has_error(function()
        require("tetravim.util.cloud.k8s-validator")
      end)
      assert.has_error(function()
  ...
  it("API surface (spring and spring_picker)", function()
    local s = require("tetravim.util.jvm.spring")
    local p = require("tetravim.util.jvm.spring_picker")
  ...
  it("API surface (coverage)", function()
    local cov = require("tetravim.util.quality.coverage")
  ...
  describe("Real workspace root discovery", function()
    ...
    it("JVM project detection", function()
      ...
      local build_util = require("tetravim.util.jvm.build")
