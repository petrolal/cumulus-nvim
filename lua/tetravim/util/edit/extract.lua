...
function M.setup_keymaps(bufnr, lang_label)
  ...
  map("n", "<leader>ce", function()
    require("tetravim.util.edit.extract").extract_interface()
  end, "Extract Interface")
  map("v", "<leader>ce", function()
    require("tetravim.util.edit.extract").extract_interface(true)
  end, "Extract Interface")

  map("n", "<leader>ci", function()
    require("tetravim.util.edit.extract").inline()
  end, "Inline")
  map("v", "<leader>ci", function()
    require("tetravim.util.edit.extract").inline(true)
  end, "Inline")

  map("n", "<leader>cm", function()
    require("tetravim.util.edit.extract").extract_method()
  end, "Extract Method")
  map("v", "<leader>cm", function()
    require("tetravim.util.edit.extract").extract_method(true)
  end, "Extract Method")

  map("n", "<leader>cv", function()
    require("tetravim.util.edit.extract").extract_variable()
  end, "Extract Variable")
  map("v", "<leader>cv", function()
    require("tetravim.util.edit.extract").extract_variable(true)
  end, "Extract Variable")

  map("n", "<leader>cc", function()
    require("tetravim.util.edit.extract").extract_constant()
  end, "Extract Constant")
  map("v", "<leader>cc", function()
    require("tetravim.util.edit.extract").extract_constant(true)
  end, "Extract Constant")
