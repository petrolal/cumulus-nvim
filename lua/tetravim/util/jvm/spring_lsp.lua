...
-- Tree-sitter heuristics in `tetravim.util.jvm.spring` (it sees beans contributed by
-- meta-annotations, `@Import`, Java config and starter auto-config that never
-- carry a stereotype annotation in project source). `tetravim.util.jvm.spring`
