...
local ast = require("tetravim.util.jvm.spring.ast")
local parse = require("tetravim.util.jvm.spring.parse")
...
--- (`tetravim.util.jvm.spring_lsp`) when it is attached -- it is compiler-accurate
...
function M.find_endpoints(root, cb)
  local ok, sl = pcall(require, "tetravim.util.jvm.spring_lsp")
...
--- (`tetravim.util.jvm.spring_lsp`), falls back to `M._find_beans_scan`.
---@param root string
---@param cb fun(beans: table[]|nil)
